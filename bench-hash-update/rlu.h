...
#define RLU_MOVE_PTR_FORWARD(p_obj, offset) ((intptr_t *)(((volatile unsigned char *)p_obj) + offset))
#define RLU_H_TO_OBJ(p_h_obj) ((volatile intptr_t *)RLU_MOVE_PTR_FORWARD(p_h_obj, RLU_OBJ_HEADER_SIZE))

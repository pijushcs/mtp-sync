...
static int hash_list_update(thread_data_t *d, int key) {
#ifdef IS_RLU
	return rlu_hash_list_update(d->p_rlu_td, d->p_hash_list, key);
#else
#ifdef IS_RCU
	return rcu_hash_list_update(d->p_hash_list, key);
#else
	return 1;
#endif
#endif
